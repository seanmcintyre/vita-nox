...
var Weekend = function Weekend(_ref) {
  ...
  return react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_2___default.a.Fragment, null, react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("h1", {
    ...
    console.log(day);
    console.log(nextDate(day) > new Date().getDate());
    return day;
  }).map(function (day) {
...
var nextDate = function nextDate(dayNum) {
  return new Date().getDay() < 6 ? new Date().getDate() + (dayNum - 1 - new Date().getDay() + 7) % 7 + 1 : new Date().getDate() + (dayNum - 1 - new Date().getDay() + 7) % 7 + 1;
};
...
//# sourceMappingURL=index.js.ffbb19222c7d285f9730.hot-update.js.map